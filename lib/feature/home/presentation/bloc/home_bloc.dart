  ...
  HomeBloc({
    ...
    on<GetPopularEvent>((event, emit) async {
      ...
      result.fold(
            (l) {
          emit(state.copyWith(
            getPopularStatus: RequestStatus.failures,
            popularFailures: l,
          ));
        },
            (r) {
          emit(state.copyWith(
            getPopularStatus: RequestStatus.success,
            popularModel: r,
          ));
        },
      );
    ...
    on<GetTopRatedEvent>((event, emit) async {
      ...
      result.fold(
            (l) {
          emit(state.copyWith(
            getTopRatedStatus: RequestStatus.failures,
            topRatedFailures: l,
          ));
        },
            (r) {
          emit(state.copyWith(
            getTopRatedStatus: RequestStatus.success,
            topRatedModel: r,
          ));
        },
      );
    ...
    on<GetUpComingEvent>((event, emit) async {
      ...
      result.fold(
            (l) {
          emit(state.copyWith(
            getUpComingStatus: RequestStatus.failures,
            upComingFailures: l,
          ));
        },
            (r) {
          emit(state.copyWith(
            getUpComingStatus: RequestStatus.success,
            upComingModel: r,
          ));
        },
      );
